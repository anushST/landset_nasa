                ...
                properties={
                    ...
                    'scenes': openapi.Schema(
                        ...
                        items=openapi.Schema(
                            type=openapi.TYPE_OBJECT,
                            properties={
                                'scene_id': openapi.Schema(type=openapi.TYPE_STRING, description='ID of the scene'),
                                'datetime': openapi.Schema(type=openapi.TYPE_STRING, format=openapi.FORMAT_DATETIME, description='Date and time of the scene'),
                                'cloud_cover': openapi.Schema(type=openapi.TYPE_NUMBER, format=openapi.FORMAT_FLOAT, description='Cloud cover percentage'),
                                'platform': openapi.Schema(type=openapi.TYPE_STRING, description='Satellite platform used'),
                                'sun_azimuth': openapi.Schema(type=openapi.TYPE_NUMBER, format=openapi.FORMAT_FLOAT, description='Sun azimuth angle'),
                                'sun_elevation': openapi.Schema(type=openapi.TYPE_NUMBER, format=openapi.FORMAT_FLOAT, description='Sun elevation angle'),
                                'thumbnail': openapi.Schema(type=openapi.TYPE_STRING, format=openapi.FORMAT_URI, description='URL of the thumbnail image')
                            }
                        )
                    )
                }
...
def scenes(request):
    ...
    search = get_landsat_items(longitude, latitude, time_range,
